...
function NetflixDocumentaries() 
{
  ...
  return (
    <div>
        <h2 style={{color: 'white', padding: 10, fontSize: 20, fontWeight: 900, marginLeft: 11}}>NETFLIX DOCUMENTARIES</h2>
...
export default NetflixDocumentaries